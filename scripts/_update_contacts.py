...
delivery = {
    ...
    "payment": "Оплата заказа возможна по расчётному счёту, банковской картой или наличными. Онлайн-оплата на сайте не подключена.",
    "fullText": (
        ...
        "Услуги транспортной компании оплачиваются покупателем при получении товара. Оплата Оплата заказа возможна "
        "по расчётному счёту, банковской картой или наличными — при самовывозе, при получении у транспортной компании "
        "или по согласованию. Онлайн-оплата на сайте не подключена."
    ),
}
