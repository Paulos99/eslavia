# -*- coding: utf-8 -*-
"""Apply Site Audit SEO package to Eslavia project (updated contacts)."""
...
TITLE = "Эславия — женский трикотаж оптом от производителя в Иваново"
DESC = (
    "Женский трикотаж оптом и в розницу от производства в Иваново. "
    "Домашние платья, пижамы, халаты. Оптовый прайс по запросу, розничные цены на сайте. Доставка по России."
)
  ...
  "@graph": [
    {
      ...
      "image": OG_IMAGE,
      "description": "Женский трикотаж оптом и в розницу от производства в Иваново.",
      "email": EMAIL,
  ...
  <body>
    <noscript>
      <main style="max-width:40rem;margin:2rem auto;font-family:system-ui,sans-serif;padding:0 1rem">
        <h1>Эславия — женский трикотаж оптом от производителя в Иваново</h1>
    ...
    <section className="hero" id="top">
      <div className="container hero-grid">
        <div className="hero-copy reveal">
          <p className="eyebrow">Эславия · производство Иваново · опт и розница</p>
          <h1>
            Женский трикотаж оптом <em>от производителя в Иваново</em>
          </h1>
          <p className="hero-lead">
            Эславия шьёт домашний трикотаж: платья, пижамы, сарафаны, халаты и сорочки. Розница — цены на сайте.
...
print("SeoFaq.tsx created")

app_path = ROOT / "src/App.tsx"
app = app_path.read_text(encoding="utf-8")
if "SeoFaq" not in app:
    app = app.replace(
        'import { Contacts } from "./components/Contacts";',
        'import { Contacts } from "./components/Contacts";\nimport { SeoFaq } from "./components/SeoFaq";',
    )
    app = app.replace("<Contacts />", "<SeoFaq />\n        <Contacts />")
    app_path.write_text(app, encoding="utf-8")
    print("App.tsx wired SeoFaq")
else:
    print("App already has SeoFaq")

css_path = ROOT / "src/styles/globals.css"
css = css_path.read_text(encoding="utf-8")
if ".faq-list" not in css:
    css += """
...
.faq-item p { margin: 0.6rem 0 0; color: #3a2e2a; }
"""
    css_path.write_text(css, encoding="utf-8")
    print("faq css added")

(ROOT / "data/lead-mail.json").write_text(
    json.dumps({"to": EMAIL}, ensure_ascii=False, indent=2) + "\n", encoding="utf-8"
)
print("done")
